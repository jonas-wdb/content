...
<pre><code class="language-sh">$ npm install --save nanomatch
</code></pre>
<details>
...
<pre><code class="language-sh">$ yarn add nanomatch
</code></pre>
<p><strong>Install with <a href="https://npmjs.com">npm</a></strong></p>
<pre><code class="language-sh">$ npm install nanomatch
</code></pre>
<h3>Usage</h3>
<p>Add nanomatch to your project using node's <code>require()</code> system:</p>
<pre><code class="language-js">var nanomatch = require('nanomatch');
...
<pre><code class="language-js">var nm = require('nanomatch');
...
<h3><a href="index.js#L662">.create</a></h3>
...
<h3><a href="index.js#L701">.parse</a></h3>
...
<h3><a href="index.js#L749">.compile</a></h3>
...
<h3><a href="index.js#L772">.clearCache</a></h3>
<p>Clear the regex cache.</p>
<p><strong>Example</strong></p>
<pre><code class="language-js">nm.clearCache();
</code></pre>
<h2>Options</h2>
<details>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">nm(['a/b.js', 'a/c.md'], '*.js');
//=&gt; []
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var files = ['abc', 'ajz'];
...
<pre><code class="language-js">nm.match(['a/b/c', 'a/b/c'], '**');
//=&gt; ['abc']
...
<p>Type: <code>Boolean</code></p>
<p>Default: <code>undefined</code></p>
<pre><code class="language-js">nm(['a/b', 'a/b/c', 'a/b/c/d'], 'a/**');
//=&gt; ['a/b', 'a/b/c', 'a/b/c/d']
...
<pre><code class="language-js">nm.match(['abc', 'a\\*c'], 'a\\*c');
//=&gt; ['a\\*c']
...
<p>Default: <code>true</code></p>
<p><strong>Example</strong></p>
<pre><code class="language-js">nm.match(['a\\b\\c'], 'a/**');
//=&gt; ['a/b/c']
...
<pre><code class="language-bash">npm i -d &amp;&amp; node benchmark
</code></pre>
<h3>Latest results</h3>
<pre><code class="language-bash"># globstar-basic (182 bytes)
...
<hr>
<p><em>This file was generated by <a href="https://github.com/verbose/verb-generate-readme">verb-generate-readme</a>, v0.6.0, on October 20, 2017.</em></p>
</body></html>