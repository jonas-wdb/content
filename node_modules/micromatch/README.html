...
<pre><code class="language-js">console.log(mm(['foo', 'bar', 'qux'], ['f*', 'b*'])); 
//=&gt; ['foo', 'bar']
</code></pre>
<p>Use <a href="#ismatch">.isMatch()</a> to get true/false:</p>
<pre><code class="language-js">console.log(mm.isMatch('foo', 'f*'));  
//=&gt; true
</code></pre>
...
<h3><a href="index.js#L785">.compile</a></h3>
...
<h3><a href="index.js#L806">.clearCache</a></h3>
<p>Clear the regex cache.</p>
<p><strong>Example</strong></p>
<pre><code class="language-js">mm.clearCache();
</code></pre>
<h2>Options</h2>
<ul>
...
<pre><code class="language-js">mm.match(['a/b/c', 'a/b/c'], 'a/b/c');
//=&gt; ['a/b/c', 'a/b/c']
...
<pre><code class="language-js">mm(['a/z', 'a/b', 'a/!(z)'], 'a/!(z)');
//=&gt; ['a/b', 'a/!(z)']
...
<p><strong>Type</strong>: <code>Boolean</code></p>
<p><strong>Default</strong>: <code>undefined</code></p>
<pre><code class="language-js">mm(['a/b', 'a/b/c', 'a/b/c/d'], 'a/**');
//=&gt; ['a/b', 'a/b/c', 'a/b/c/d']
...
<pre><code class="language-js">mm.match(['abc', 'a\\*c'], 'a\\*c');
//=&gt; ['a\\*c']
...
<p><strong>Example</strong></p>
<pre><code class="language-js">mm.match(['a\\b\\c'], 'a/**');
//=&gt; ['a/b/c']
...
<pre><code class="language-bash">npm i -d &amp;&amp; npm run benchmark
</code></pre>
<h3>Latest results</h3>
<p>As of October 20, 2017 (longer bars are better):</p>
<pre><code class="language-sh"># braces-globstar-large-list (485691 bytes)
...
<tr>
<td>2</td>
<td><a href="https://github.com/olstenlarck-old">olstenlarck-old</a></td>
</tr>
<tr>
<td>1</td>
