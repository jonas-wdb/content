...
<pre><code class="language-sh">$ yarn add fill-range
</code></pre>
<h2>Usage</h2>
...
<pre><code class="language-js">var fill = require('fill-range');
...
<p><strong>Example(s)</strong></p>
<pre><code class="language-js">// increase padding by two
