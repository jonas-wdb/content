...
<pre><code class="language-sh">$ npm install --save is-data-descriptor
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var isDataDesc = require('is-data-descriptor');
</code></pre>
<h2>Examples</h2>
<p><code>true</code> when the descriptor has valid properties with valid values.</p>
<pre><code class="language-js">// `value` can be anything
...
<pre><code class="language-js">isDataDesc('a')
//=&gt; false
isDataDesc(null)
//=&gt; false
isDataDesc([])
...
<pre><code class="language-js">isDataDesc({value: 'foo', bar: 'baz'})
//=&gt; false
...
<pre><code class="language-js">isDataDesc({value: 'foo', enumerable: 'foo'})
//=&gt; false
