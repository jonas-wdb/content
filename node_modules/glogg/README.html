<!DOCTYPE html><html><head><title></title><link type="text/css" rel="stylesheet" href="./markdown.css"></head><body><h1>glogg</h1>
<p><a href="https://travis-ci.org/js-cli/glogg"><img src="https://img.shields.io/travis/js-cli/glogg/master.svg?label=travis&amp;style=flat-square" alt="Travis Build Status"></a></p>
<p>Global logging utility</p>
<h2>Usage</h2>
<pre><code class="language-js">var getLogger = require('glogg');
