...
<pre><code class="language-sh">$ npm install --save object.map
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var mapValues = require('object.map');
...
<pre><code class="language-js">var result = mapValues({a: 'b'}, function(val, key, obj) {
  return this.foo;
}, {foo: 'bar'});
console.log(result);
//=&gt; {a: 'bar'}
