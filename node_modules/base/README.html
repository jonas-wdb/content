<!DOCTYPE html><html><head><title></title><link type="text/css" rel="stylesheet" href="./markdown.css"></head><body><p align="center">
...
<pre><code class="language-sh">$ npm install --save base
</code></pre>
<h2>What is Base?</h2>
...
<pre><code class="language-js">var base = new Base();
...
<pre><code class="language-js">var Base = require('base');
...
<pre><code class="language-js">// initialize with `config` and `options`
...
<p><strong>Example</strong></p>
<pre><code class="language-js">app.is('foo');
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var app = new Base()
  .use(foo)
  .use(bar)
  .use(baz)
</code></pre>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">// arbitrary `render` function using lodash `template`
...
<p><strong>Example</strong></p>
<pre><code class="language-js">app.mixin('foo', function() {
  // do stuff
});
</code></pre>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">// create an instance of `Base`, this is our first (&quot;base&quot;) instance
var first = new Base();
...
<p><strong>Example</strong></p>
<pre><code class="language-js">Base.use(function(app) {
  app.foo = 'bar';
});
var app = new Base();
console.log(app.foo);
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var extend = cu.extend(Parent);
Parent.extend(Child);
...
<p><strong>Example</strong></p>
<pre><code class="language-js">Base.mixin(function(proto) {
...
<p><strong>Example</strong></p>
<pre><code class="language-js">Base.extend(Child);
Base.mixins(Child);
</code></pre>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">Base.inherit(Foo, Bar);
</code></pre>
<h2>In the wild</h2>
