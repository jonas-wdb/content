<!DOCTYPE html><html><head><title></title><link type="text/css" rel="stylesheet" href="./markdown.css"></head><body><h1>markdown-it</h1>
...
<a href="https://coveralls.io/r/markdown-it/markdown-it?branch=master"><img src="https://img.shields.io/coveralls/markdown-it/markdown-it/master.svg?style=flat" alt="Coverage Status"></a>
...
<pre><code class="language-js">// Activate/deactivate rules, with curring
var md = require('markdown-it')()
            .disable([ 'link', 'image' ])
            .enable([ 'link' ])
            .enable('image');
...
<pre><code class="language-bash">$ benchmark/benchmark.js readme
