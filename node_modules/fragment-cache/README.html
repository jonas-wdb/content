...
<pre><code class="language-js">var fragment = new FragmentCache();
</code></pre>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var cache = fragment.cache('files');
...
<p><strong>Example</strong></p>
<pre><code class="language-js">fragment.set('files', 'somefile.js', new File({path: 'somefile.js'}));
</code></pre>
<p><strong>Params</strong></p>
<ul>
