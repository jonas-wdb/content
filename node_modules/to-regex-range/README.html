...
<pre><code class="language-sh">$ yarn add to-regex-range
</code></pre>
<details>
...
<pre><code class="language-js">var toRegexRange = require('to-regex-range');
...
<pre><code class="language-js">var source = toRegexRange('15', '95');
//=&gt; 1[5-9]|[2-8][0-9]|9[0-5]
...
<pre><code class="language-js">console.log(toRegexRange('-001', '100'));
...
<pre><code class="language-js">var regex = toRegexRange('-001', '100');
</code></pre>
