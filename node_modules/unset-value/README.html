...
<pre><code class="language-js">var obj = {a: 'b'};
unset(obj, 'a');
console.log(obj);
//=&gt; {}
</code></pre>
<h3>Returns true when a property is deleted</h3>
<pre><code class="language-js">unset({a: 'b'}, 'a') // true
</code></pre>
...
<pre><code class="language-js">unset({a: {b: {c: 'd'}}}, 'd') // true
</code></pre>
<h3>delete nested values</h3>
<pre><code class="language-js">var one = {a: {b: {c: 'd'}}};
unset(one, 'a.b');
console.log(one);
//=&gt; {a: {}}
...
<pre><code class="language-js">unset();
// 'expected an object.'
</code></pre>
<h2>About</h2>
