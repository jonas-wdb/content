...
<pre><code class="language-sh">$ npm install --save union-value
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var union = require('union-value');
