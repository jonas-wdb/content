...
<pre><code class="language-sh">$ npm install --save split-string
</code></pre>
...
<pre><code class="language-js">console.log('a.b.c'.split('.'));
//=&gt; ['a', 'b', 'c']
</code></pre>
...
<pre><code class="language-js">var split = require('split-string');
...
<pre><code class="language-js">split('a (b c d) e', ' ');
//=&gt; ['a', '(b c d)', 'e']
</code></pre>
<h2>Options</h2>
...
<pre><code class="language-js">// no bracket support by default
split('a.{b.c}');
//=&gt; [ 'a', '{b', 'c}' ]
...
<pre><code class="language-js">split('a.b,c', {sep: ','});
//=&gt; ['a.b', 'c']
...
<p><strong>Example</strong></p>
<pre><code class="language-js">split('a.b\\.c');
//=&gt; ['a', 'b.c']
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var arr = split('a.b', function(tok) {
