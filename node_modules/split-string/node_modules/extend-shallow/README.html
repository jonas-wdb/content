...
<pre><code class="language-sh">$ npm install --save extend-shallow
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var extend = require('extend-shallow');
