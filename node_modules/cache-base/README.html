...
<pre><code class="language-sh">$ npm install --save cache-base
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var Cache = require('cache-base');
...
<pre><code class="language-js">var Cache = require('cache-base').namespace('data');
var app = new Cache();
app.set('a', 'b');
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var app = new Cache();
</code></pre>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">app.on('set', function(key, val) {
...
<p><strong>Example</strong></p>
<pre><code class="language-js">app.union('a.b', ['foo']);
app.union('a.b', ['bar']);
...
<p><strong>Example</strong></p>
<pre><code class="language-js">app.set('a.b.c', 'd');
app.get('a.b');
//=&gt; {c: 'd'}
...
<p><strong>Example</strong></p>
<pre><code class="language-js">app.set('foo', 'bar');
app.has('foo');
//=&gt; true
</code></pre>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">app.del(); // delete all
// or
app.del('foo');
// or
app.del(['foo', 'bar']);
...
<p><strong>Example</strong></p>
<pre><code class="language-js">app.clear();
</code></pre>
