...
<pre><code class="language-sh">$ npm install --save is-descriptor
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var isDescriptor = require('is-descriptor');
...
<pre><code class="language-js">isDescriptor('a');
//=&gt; false
isDescriptor(null);
//=&gt; false
isDescriptor([]);
...
<pre><code class="language-js">isDescriptor({value: 'foo'});
//=&gt; true
isDescriptor({value: noop});
//=&gt; true
</code></pre>
<p><code>false</code> when the object has invalid properties</p>
<pre><code class="language-js">isDescriptor({value: 'foo', bar: 'baz'});
//=&gt; false
...
<pre><code class="language-js">isDescriptor({value: 'foo', enumerable: 'foo'});
//=&gt; false
...
<p><code>true</code> when the object has valid properties with valid values.</p>
<pre><code class="language-js">isDescriptor({get: noop, set: noop});
//=&gt; true
...
<p><code>false</code> when the object has invalid properties</p>
<pre><code class="language-js">isDescriptor({get: noop, set: noop, bar: 'baz'});
//=&gt; false
...
<pre><code class="language-js">isDescriptor({get: noop, set: 'baz'});
//=&gt; false
...
<p><code>false</code> when a value is not the correct type</p>
<pre><code class="language-js">isDescriptor({get: noop, set: noop, enumerable: 'foo'});
//=&gt; false
