...
<pre><code class="language-sh">$ npm install --save snapdragon-util
</code></pre>
<p>Install with <a href="https://yarnpkg.com">yarn</a>:</p>
<pre><code class="language-sh">$ yarn add snapdragon-util
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var util = require('snapdragon-util');
</code></pre>
<h2>API</h2>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">// do nothing for beginning-of-string
...
<p><strong>Example</strong></p>
<pre><code class="language-js">snapdragon.compiler.set('text', utils.identity);
</code></pre>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">snapdragon.compiler
  .set('i', function(node) {
    this.mapVisit(node);
  })
...
<p><strong>Example</strong></p>
<pre><code class="language-js">utils.toNoop(node);
...
<p><strong>Example</strong></p>
<pre><code class="language-js">snapdragon.compiler.set('i', function(node) {
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var parent = new Node({type: 'foo'});
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var parent = new Node({type: 'abc'});
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var state = { inside: {}};
...
<p><strong>Example</strong></p>
<pre><code class="language-js">console.log(utils.arraify(''));
//=&gt; []
