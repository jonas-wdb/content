...
<pre><code class="language-js">console.log(brackets('[![:lower:]]'));
//=&gt; '[^a-z]'
</code></pre>
<h2>API</h2>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">var res = brackets('[:alpha:]', {sourcemap: true});
