<!DOCTYPE html><html><head><title></title><link type="text/css" rel="stylesheet" href="./markdown.css"></head><body><h1>natives</h1>
...
Isaac Z. Schlueter</p>
<h2>USAGE</h2>
<pre><code class="language-javascript">var natives = require('natives')
