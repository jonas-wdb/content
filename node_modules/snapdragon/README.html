...
<pre><code class="language-js">var Snapdragon = require('snapdragon');
var snapdragon = new Snapdragon();
</code></pre>
<p><strong>Parse</strong></p>
<pre><code class="language-js">var ast = snapdragon.parser('some string', options)
...
<pre><code class="language-js">// pass the `ast` from the parse method
...
<pre><code class="language-js">var ast = snapdragon.parser(str, options)
  .use(function() {
...
<pre><code class="language-js">{ type: 'dot',
  val: '.',
  position:
...
<pre><code class="language-js">var res = snapdragon.compiler(ast)
...
<pre><code class="language-js">var ast = snapdragon.parser('.')
  .use(function () {
    var pos = this.position();
    var m = this.match(/^\./);
    if (!m) return;
...
<p><strong>Example</strong></p>
<pre><code class="language-js">parser.define('foo', 'bar');
</code></pre>
<p><strong>Params</strong></p>
<ul>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">parser.isType(node, 'brace');
</code></pre>
<p><strong>Params</strong></p>
<ul>
...
<p><strong>Example</strong></p>
<pre><code class="language-js">compiler.define('foo', 'bar');
</code></pre>
<p><strong>Params</strong></p>
<ul>
<li><code>key</code> <strong>{String}</strong>: propery name</li>
