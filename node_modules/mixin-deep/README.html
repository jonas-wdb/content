...
<pre><code class="language-sh">$ npm install --save mixin-deep
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var mixinDeep = require('mixin-deep');
