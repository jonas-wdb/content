...
<pre><code class="language-sh">$ npm install --save class-utils
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var cu = require('class-utils');
</code></pre>
<h2>API</h2>
...
<pre><code class="language-js">cu.has(['a', 'b', 'c'], 'c');
//=&gt; true
...
<p><strong>Example</strong></p>
<pre><code class="language-js">cu.hasAll(['a', 'b', 'c'], 'c');
//=&gt; true
...
<p><strong>Example</strong></p>
<pre><code class="language-js">cu.arrayify('foo');
//=&gt; ['foo']
...
<p><strong>Example</strong></p>
<pre><code class="language-js">cu.hasConstructor({});
//=&gt; true
...
<p><strong>Example</strong></p>
<pre><code class="language-js">cu.nativeKeys({a: 'b', b: 'c', c: 'd'})
//=&gt; ['a', 'b', 'c']
