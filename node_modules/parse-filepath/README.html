...
<pre><code class="language-sh">$ npm install parse-filepath --save
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var parsePath = require('parse-filepath');
parsePath(filepath);
</code></pre>
