...
<pre><code class="language-sh">$ npm install --save array-slice
</code></pre>
...
<h2>Usage</h2>
<pre><code class="language-js">var slice = require('array-slice');
