...
<pre><code class="language-sh">#1: five-arrays
...
<h2>Usage</h2>
<pre><code class="language-js">var union = require('arr-union');

union(['a'], ['b', 'c'], ['d', 'e', 'f']);
//=&gt; ['a', 'b', 'c', 'd', 'e', 'f']
</code></pre>
<p>Returns only unique elements:</p>
<pre><code class="language-js">union(['a', 'a'], ['b', 'c']);
//=&gt; ['a', 'b', 'c']
</code></pre>
...
<pre><code class="language-sh">$ npm i verb &amp;&amp; npm run docs
</code></pre>
