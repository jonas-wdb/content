...
<pre><code class="language-sh">$ npm install --save is-accessor-descriptor
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">var isAccessor = require('is-accessor-descriptor');

isAccessor({get: function() {}});
//=&gt; true
</code></pre>
<p>You may also pass an object and property name to check if the property is an accessor:</p>
<pre><code class="language-js">isAccessor(foo, 'bar');
</code></pre>
<h2>Examples</h2>
<p><code>false</code> when not an object</p>
<pre><code class="language-js">isAccessor('a')
isAccessor(null)
isAccessor([])
//=&gt; false
</code></pre>
...
<pre><code class="language-js">isAccessor({get: noop, set: noop, enumerable: 'foo'})
